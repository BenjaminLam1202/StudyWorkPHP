...
<body>
	<div class="container">
		...
		<div class="container-fluid" id="conindex" style="background-color: #0455BF;" required>
			<form action="view/confirm/confirm.php" method="post" id="fi" enctype="multipart/form-data" >
				<!--<form action="view/confirm/confirm.php" method="post" id="fi" >-->
				<div class="container">
				...
				<div class="w-100 p-1">
					<div class="input-group mb-3">
						...
						<input type="text" style="text-transform: capitalize;" class="form-control btna" placeholder="Name" aria-label="Name" aria-describedby="basic-addon1" name="name" id="name" value="<?php if (isset($name)) { echo $name; 
				...
				<div class="w-100 p-1">
					<div class="input-group mb-3">
						...
						<input type="email" class="form-control btna" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" name="email" id="email" value="<?php if (isset($email)) { echo $email; } ?>" required>
				...
				<div class="w-100 p-1">
					<div class="input-group mb-3">
						...
						<input type="number" class="form-control btna" placeholder="Experience" aria-label="Email" aria-describedby="basic-addon1" name="exp" id="exp" value="<?php if (isset($exp)) { echo $exp; } ?>" required>
					</div>
				</div>
				...
				<div class="w-100 p-1">
					<div class="input-group mb-3">
						...
						<input type="tel" class="form-control btna" placeholder="Phone" aria-label="Phone" aria-describedby="basic-addon1" id="phone" name="phone" placeholder="123-4567-8912" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" value="<?php if (isset($phone)) { echo $phone; } ?>" required>
				...
				<div class="w-100 p-1">
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control btna" placeholder="Address" aria-label="Address" aria-describedby="basic-addon1" name="address" style="text-transform: capitalize;" id="address" value="<?php if (isset($address)) { echo $address; } ?>" required>
				...
				<div class="w-100 p-1">
					<div class="input-group mb-3">
						...
						<input type="file" class="form-control btna" id="basic-url" placeholder="Url Resume (doc/pdf)" aria-label="Url resume (doc/pdf)"aria-describedby="basic-addon3" name="resume" id="resume" accept="application/pdf,application/msword" value="<?php if (isset($resume)) { echo $resume; } ?>" required>
					</div>
				</div>
				<div class="w-100 p-1">
					<div class="input-group mb-3">
						...
						<input type="file" class="form-control btna" id="basic-url" placeholder="Url 3x4 image" aria-label="Url 3x4 image" aria-describedby="basic-addon3" name="avatar" id="avatar" value="<?php if (isset($avatar)) { echo $avatar; } ?>"  accept="image/jpeg,image/png"required>
